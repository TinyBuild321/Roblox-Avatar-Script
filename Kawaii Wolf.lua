...
local LayeredClothing = false

if Permanent == true then
    function KawaiiWolf(Character)
        ...
        if LayeredClothing == false then
            local Shirt = Instance.new("Shirt")
            local Pants = Instance.new("Pants")

            Shirt.Parent = game.Players.LocalPlayer.Character
            Shirt.Name = "Shirt"
            Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=6216533183"

            Pants.Parent = game.Players.LocalPlayer.Character
            Pants.Name = "Pants"
            Pants.PantsTemplate = "http://www.roblox.com/asset/?id=6216539645"
        end
        ...
        local Rbx4 = 6192193324
        local Rbx4 = game:GetObjects("rbxassetid://" .. tostring(Rbx4))[1]
        Rbx9(game.Players.LocalPlayer.Character, Rbx4)

        if LayeredClothing == true then
            function Rbx1(Rbx2, Rbx4)
                local Rbx3 = Instance.new("Weld")
                Rbx3.Part0 = Rbx2.Parent
                Rbx3.Part1 = Rbx4.Parent
            ...
            function Rbx9(Rbx6, Rbx4)
                ...
                if Rbx7 then
                    ...
                    if Rbx2 then
                        ...
                        local Rbx5 = e:FindFirstChild("UpperTorso")
                        if Rbx5 then
                            local Rbx2 = CFrame.new(0, 0, 0)
                            local Rbx4 = Rbx4.AttachmentPoint
                            Rbx3("UpperTorsoWeld", Rbx5, Rbx5, Rbx7, Rbx2, Rbx4)
                        end
                    end
                end
            end
            local Rbx4 = 9503715794
            local Rbx4 = game:GetObjects("rbxassetid://" .. tostring(Rbx4))[1]
            Rbx9(game.Players.LocalPlayer.Character, Rbx4)
        end
    ...
    KawaiiWolf(game.Players.LocalPlayer.Character)
    game.Players.LocalPlayer.CharacterAdded:Connect(KawaiiWolf)
end
