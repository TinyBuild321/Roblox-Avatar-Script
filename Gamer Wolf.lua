...
if Permanent == true then
    function GamerWolf(Character)
        ...
        if LayeredClothing == false then
            ...
            Shirt.Name = "Shirt"
            Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=6150616385"

            Pants.Parent = game.Players.LocalPlayer.Character
            Pants.Name = "Pants"
            Pants.PantsTemplate = "http://www.roblox.com/asset/?id=6387076642"
        end
    ...
    GamerWolf(game.Players.LocalPlayer.Character)
    game.Players.LocalPlayer.CharacterAdded:Connect(GamerWolf)
end
