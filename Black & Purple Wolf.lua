...
if Permanent == true then
    function BlackAndPurpleWolf(Character)
        ...
        Shirt.Name = "Shirt"
        Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=6152779262"

        Pants.Parent = game.Players.LocalPlayer.Character
        Pants.Name = "Pants"
        Pants.PantsTemplate = "http://www.roblox.com/asset/?id=6152782773"
        ...
        local Rbx4 = 6076009631
        local Rbx4 = game:GetObjects("rbxassetid://" .. tostring(Rbx4))[1]
        Rbx9(game.Players.LocalPlayer.Character, Rbx4)

        game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false
    end
    BlackAndPurpleWolf(game.Players.LocalPlayer.Character)
    game.Players.LocalPlayer.CharacterAdded:Connect(BlackAndPurpleWolf)
end
